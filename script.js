if (window.location.href == "http://127.0.0.1:5500/3.html") {
...
sessionStorage.setItem("local-date", document.getElementById('summary-date').innerText);
sessionStorage.setItem("local-time", document.getElementById('summary-time').innerText);
sessionStorage.setItem("local-duration", document.getElementById('summary-duration').innerText);
sessionStorage.setItem("local-tickets", document.getElementById('summary-tickets').innerText);
sessionStorage.setItem("local-total", document.getElementById('summary-total').innerText);
